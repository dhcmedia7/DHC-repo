...
const services = [
  ...
  },
  {
    name: "ন্যাচারোপ্যাথি",
    description:
      "এটি সম্পূর্ণ প্রাকৃতিক উপায়ে চিকিৎসা করার একটি সামগ্রিক পদ্ধতি, যেখানে সঠিক খাদ্য, জীবনযাত্রা ও প্রকৃতির নিরাময় শক্তিকে কাজে লাগিয়ে শরীরের অভ্যন্তরীণ রোগ প্রতিরোধ ক্ষমতা বৃদ্ধি করা হয় এবং বিভিন্ন দীর্ঘস্থায়ী রোগের কারণ নির্ণয় করে ভেষজ ওষুধের মাধ্যমে সেগুলির সমাধান করা হয়।",
